...
public class HomeController {
    ...
    public String getIndexPage(Model model, Page page) {
        // Before invoking the method, Spring MVC will automatically instantiate model and page, and it will inject page into model
        // Hence, thymeleaf can access the data from page
